function SideBar() {
  return (
    <div className="fixed flex justify-center left-0 top-[56px] h-full bg-amber-50 shadow-md w-1/5 z-30 shadow-amber-950 p-2">
      <div className="flex flex-row p-2 justify-center bg-fuchsia-300 w-full relative ">
        ...
        <button className="btn-exit absolute top-1 right-1">X</button>
      </div>
    </div>
  );
}

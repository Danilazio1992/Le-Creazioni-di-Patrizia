...
function SideBar() {
  ...
  return (
    <div
      className={`fixed flex justify-center left-0 top-[0%] h-full bg-amber-50 shadow-md w-1/5 z-30 shadow-amber-950 p-2 transform transition-transform duration-1000 ease-in-out ${uiState.isSideBar ? "translate-x-0" : "-translate-x-full"}`}
    >

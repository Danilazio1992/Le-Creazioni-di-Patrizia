...
function CreateCardForm({ setNewData, setIsModal }) {
  ...
  const handleAddCity = (el) => {
    setNewData((prevData) => [...prevData, el]);
  };
      ...
      <form className=" flex flex-col w-full gap-4">
        <div className="flex justify-items-start w-full">
          ...
          <input
            type="text"
            name="name"
            placeholder="insert City Name EXAMPLE: Rome"
            className=" bg-amber-50 w-3/5 rounded-xs"
        ...
        <div className="flex justify-items-start w-full">
          ...
          <input
            type="url"
            name="imgUrl"
            placeholder="insert and img URL"
            className=" bg-amber-50 w-3/5 rounded-xs"
            onChange={(e) => handleChange(e)}
            value={city.imgUrl}
          />
        ...
        <div className="flex justify-items-start w-full h-fit">
          ...
          <input
            type="text"
            name="description"
            placeholder="insert description of city EXAMPLE: city where you can try a real carbonara"
            className=" bg-amber-50 w-3/5 rounded-xs"
            onChange={(e) => handleChange(e)}
